...
class Segmentor():
    def __init__(self, args):
        ...
        self.model = smp.Unet(encoder_name='resnet50', encoder_weights='imagenet', classes=1, activation='sigmoid')
    ...
    def test_model(self, path):
        self.test_model = smp.utils.train.ValidEpoch(torch.load(path), loss=self.loss, metrics=self.metrics, device=self.device, verbose=True)
